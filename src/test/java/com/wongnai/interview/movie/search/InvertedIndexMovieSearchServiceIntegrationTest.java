...
public class InvertedIndexMovieSearchServiceIntegrationTest {
    ...
    @Test
    public void testFindSingleKeywordContainInTitle() throws IOException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testFindSingleKeywordContainInTitleWithCaseInsensitive() throws IOException, ExecutionException, InterruptedException {
        List<Movie> result = searchService.search("glorious");
    ...
    @Test
    public void testPartialWordMustNotMatch() throws IOException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testFullMovieNameMustMatchMovie() throws IOException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testMultiKeywordsMustFoundMoviesContainAllOfKeywords() throws IOException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testMultiKeywordsCaseInsensitive() throws IOException, ExecutionException, InterruptedException {
        List<Movie> result = searchService.search("gLoRiOuS OnE");
